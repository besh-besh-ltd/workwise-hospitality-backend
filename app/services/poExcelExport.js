...
import {
  ...
  sendWorkbook,
  datedFilename,
} from "./reports/excelKit.js";

// These four used to be private to this file. The Reports module needs the
// same IST mechanics and the same streaming contract, so they now live in
// excelKit.js and this file is one of its two callers. Re-exported because the
// PO controllers import sendWorkbook/datedFilename from here.
export { sendWorkbook, datedFilename };
