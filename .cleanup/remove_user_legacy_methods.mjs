#!/usr/bin/env node
// Phase H.1 — strip legacy buyer-side subscription/coupon/razorpay/communication
// methods from usersController.js. All have ZERO route callers after the
// usersRoutes.js edits in this commit. The hospitality replacements
// (hospitalitySubscriptionPayment, generateHospitalityInvoice) are NOT in this
// list and stay untouched.

import fs from 'fs';

const TARGET = '/Users/apple/Documents/Workwise/hospitality/backend/app/controllers/users/usersController.js';
...
console.log(`Removed ${removed.length} dead controller methods from usersController.js:`);
