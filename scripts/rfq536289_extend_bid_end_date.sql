...
--
--  DO NOT RUN YET. The deadline is a required parameter with no safe default.
--  Kamat Hotels must tell us how long to re-open for; pass their answer in.
-- ===========================================================================
--
--  WHY THIS EXISTS
--  ---------------
