...
\restrict 4iYvkweprKpGCDEeusYa3UXb9A1ZL0elf3cmbvob2PGSgweg2r0CjiAlhJr4eYK
...
CREATE TABLE public.tbl_department (
    ...
    access_type character varying(20) DEFAULT 'INDIVIDUAL'::character varying NOT NULL
);
...
CREATE TABLE public.tbl_rfq_change_history (
    ...
    CONSTRAINT chk_rfq_change_history_entity_type CHECK (((entity_type)::text = ANY ((ARRAY['RFQ'::character varying, 'PRODUCT'::character varying, 'PRODUCT_SPEC'::character varying, 'PRODUCT_FILE'::character varying, 'PRODUCT_VENDOR'::character varying, 'PRODUCT_TECH_EVAL'::character varying, 'TERMS'::character varying])::text[])))
);
...
CREATE TABLE public.tbl_vendor_hotel_category_subscription (
    ...
    CONSTRAINT tbl_vendor_hotel_category_subscription_item_type_check CHECK (((item_type)::text = ANY (ARRAY[('category'::character varying)::text, ('hotel'::character varying)::text, ('subcategory'::character varying)::text]))),
...
--
-- Name: idx_ai_pending_entity; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_pending_entity ON public.tbl_approval_instances USING btree (status, entity_type, entity_id) WHERE ((status)::text = 'PENDING'::text);
...
--
-- Name: idx_hc_id_not_deleted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hc_id_not_deleted ON public.tbl_hospitality_companies USING btree (id) WHERE (is_deleted = 0);


--
-- Name: idx_hch_id_not_deleted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hch_id_not_deleted ON public.tbl_hospitality_company_hotels USING btree (id) WHERE (is_deleted = 0);
...
--
-- Name: idx_hum_company; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hum_company ON public.tbl_hospitality_user_mappings USING btree (hospitality_company_id);


--
-- Name: idx_hum_hotel; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hum_hotel ON public.tbl_hospitality_user_mappings USING btree (hospitality_hotel_id);


--
-- Name: idx_hum_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hum_user ON public.tbl_hospitality_user_mappings USING btree (user_id);


--
-- Name: idx_hum_user_company; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hum_user_company ON public.tbl_hospitality_user_mappings USING btree (user_id, hospitality_company_id);


--
-- Name: idx_hum_user_company_hotel; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hum_user_company_hotel ON public.tbl_hospitality_user_mappings USING btree (user_id, hospitality_company_id, hospitality_hotel_id);


--
-- Name: idx_hum_user_covering; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hum_user_covering ON public.tbl_hospitality_user_mappings USING btree (user_id) INCLUDE (id, mapping_type, hospitality_company_id, hospitality_hotel_id, auto_map_projects);


--
-- Name: idx_hum_user_hotel; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_hum_user_hotel ON public.tbl_hospitality_user_mappings USING btree (user_id, hospitality_hotel_id);
...
--
-- Name: idx_rfq_published_status_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rfq_published_status_timestamp ON public.tbl_rfq USING btree (is_published, status, "timestamp" DESC) INCLUDE (created_by, hospitality_company_id, hotel_id, is_tender, rfq_no, title);
...
--
-- Name: idx_rfq_rfqno_text; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rfq_rfqno_text ON public.tbl_rfq USING btree (((rfq_no)::text) text_pattern_ops);
...
--
-- Name: idx_rfq_title_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rfq_title_trgm ON public.tbl_rfq USING gin (title public.gin_trgm_ops);
...
--
-- Name: idx_tech_eval_comments_clause_receiver; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tech_eval_comments_clause_receiver ON public.tbl_rfq_product_tech_evaluation_comments USING btree (tbl_rfq_product_tech_evaluation_clauses_id, receiver_id);


--
-- Name: idx_tech_eval_comments_clause_sender; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tech_eval_comments_clause_sender ON public.tbl_rfq_product_tech_evaluation_comments USING btree (tbl_rfq_product_tech_evaluation_clauses_id, sender_id);


--
-- Name: idx_tech_eval_comments_files_comment_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tech_eval_comments_files_comment_id ON public.tbl_rfq_product_tech_evaluation_comments_files USING btree (tbl_rfq_product_tech_evaluation_comments_id);
...
--
-- Name: idx_urs_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_urs_user ON public.tbl_user_role_scopes USING btree (user_id);
...
--
-- Name: idx_user_dept_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_user_dept_user ON public.tbl_user_department USING btree (user_id);


--
-- Name: idx_user_dept_user_dept; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_user_dept_user_dept ON public.tbl_user_department USING btree (user_id) INCLUDE (department_id);
...
CREATE INDEX idx_users_company_active ON public.tbl_users USING btree (company_id, is_deleted, status) INCLUDE (name, email, mobile, user_type, created_at, employee_type, employee_code, designation, payroll_company_id);


--
-- Name: idx_users_company_deleted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_users_company_deleted ON public.tbl_users USING btree (company_id, is_deleted);
...
CREATE INDEX idx_users_email_trgm ON public.tbl_users USING gin (email public.gin_trgm_ops);


--
-- Name: idx_users_empcode_trgm; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_users_empcode_trgm ON public.tbl_users USING gin (employee_code public.gin_trgm_ops);
...
CREATE INDEX idx_users_name_trgm ON public.tbl_users USING gin (name public.gin_trgm_ops);
